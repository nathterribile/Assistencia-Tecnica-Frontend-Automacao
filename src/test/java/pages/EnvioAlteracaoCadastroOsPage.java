...
import elements.EnvioAlteracaoCadastroOsElements;

public class EnvioAlteracaoCadastroOsPage extends EnvioAlteracaoCadastroOsElements {

    public EnvioAlteracaoCadastroOsPage(){
    ...
    public void selecionarDataEntrega(String textoSelectDataEntregaAlterado){
        BasePage.waitVisibilityOf(inputDataEntrega);
        BasePage.moveToElement(inputDataEntrega);
        inputDataEntrega.sendKeys(textoSelectDataEntregaAlterado);
    }

    public void selecionarStatus(String textoSelectStatusAlterado){
        BasePage.waitVisibilityOf(selectStatus);
        BasePage.moveToElement(selectStatus);
        selectStatus.sendKeys(textoSelectStatusAlterado);
    }  

    public void inputarTextareaObs(String textoTextareaObsAlterado){
        BasePage.waitVisibilityOf(textareaObs);
        BasePage.moveToElement(textareaObs);
        textareaObs.sendKeys(textoTextareaObsAlterado);
    }
