...
public class PedidoAlteracaoCadastroOsElements extends BasePage {
    ...
    public static WebElement headerTabelaCadastro;

    @FindBy(xpath = "/html/body/main/section[2]/div/table/tbody")
    public static WebElement linhaApagadaTabelaCadastro;

    @FindBy(xpath = "/html/body/main/section[1]/form/div/div[9]/button")
    public static WebElement botaoAlterarCadastroEquipamto;
}
