...
@FindBy(xpath = "/html/body/main/div[2]/div[4]/div/div/div[2]/div/button")
...
@FindBy(xpath = "/html/body/main/div[2]/div[4]/div/div/div[1]/h1")
public static WebElement texto1;

@FindBy(xpath = "/html/body/main/div[2]/div[4]/div/div/div[2]/p")
